...
public class FoodConverter {
	public static FoodDTO toFoodDTO(Food food, List<NewIngredientDTO> ingredients) {
	...
	public static FoodDetailDTO toFoodDetailDTO(Food food, List<IngredientDTO> ingredients) {
